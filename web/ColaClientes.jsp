    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid px-4">
        ...
        <hr>
               ...
               <div class="row my-5">
          <h3 class="fs-4 mb-3">Lista de Clientes</h3>
             <!-- Botón para Crear Nuevo Usuario -->
        <a href="CrearCliente.jsp" class="btn btn-success mb-3">Crear Nuevo Cliente</a>
        
          <%
            Cliente l = new Cliente();
            LinkedList<Cliente> lista = l.listarClientes();
            int cont = 0;
          %>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><%= lx.getUsuario() %></td>
                  <td><%= lx.getPass() %></td>
                  <td><%= lx.getDireccion() %></td>
                  <td><%= lx.getDni() %></td>
                  <td><%= lx.getTelefono() %></td>
                  <td>
                   <a href="VerClienteServlet?cliente=<%=lx.getUsuario()%>" class="btn btn-info">Ver</a>
                  </td>
...
<td>
  <form action="EditarCliente.jsp" method="get">
    ...
    <input type="hidden" name="cliente" value="<%= lx.getUsuario() %>">
...
<td>
    <form action="EliminarClienteServlet" method="post">
        <input type="hidden" name="cliente_id" value="<%= lx.getClienteId() %>">
              ...
              <div class="row">
                ...
                <div class="col-12 col-md-8">
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col-12">
                      <h3>Direccion: Av. Ejemplo 123, Lima, PerÃº</h3>
                    </div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-12">
