  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid px-4">
        ...
        <a href="CrearDetallesPedido.jsp" class="btn btn-success mb-3">Crear Nuevo Detalle del Pedido</a>
        
          <%
            DetallesPedido a = new DetallesPedido();
            LinkedList<DetallesPedido> lista = a.listarDetallesPedidos();
            int cont = 0;
          %>
            ...
            <table class="table table-striped">
              <thead>
                <tr>
                  ...
                  <th class="top" scope="col">Pedido ID</th>
                  <th class="top" scope="col">Producto ID</th>
                  <th class="top" scope="col">Cantidad</th>
                  <th class="top" scope="col">Subtotal</th>
              ...
              <tbody>
                <%
                  for (DetallesPedido ax : lista) {
                  cont++;
                %>

                  <td><%= cont %></td>
                  
                  <td><%= ax.getPedidoId() %></td>
                  <td><%= ax.getProductoId() %></td>
                  <td><%= ax.getCantidad() %></td>
                  <td><%= ax.getSubtotal() %></td>

                  <td>
                         <a href="VerDetallesPedidoServlet?detalleId=<%= ax.getDetalleId() %>" class="btn btn-info">Ver</a>
                  </td>


<!-- BotÛn Editar -->
<td>
    <a href="EditarPedidoServlet?pedidoId=<%= ax.getPedidoId()%>" class="btn btn-warning">Editar</a>
</td>
                  ...
                  <!-- BotÛn Eliminar -->
<td>
    <a href="EliminarDetallesPedidoServlet?detalleId=<%= ax.getDetalleId() %>" class="btn btn-danger" onclick="return confirm('øEst·s seguro de que deseas eliminar este producto?');">Eliminar</a>
</td>
