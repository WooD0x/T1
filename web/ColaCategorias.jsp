  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid px-4">
        ...
        <a href="CrearCategoria.jsp" class="btn btn-success mb-3">Crear Nueva Categoria</a>
        
          <%
            Categoria c = new Categoria();
            LinkedList<Categoria> lista = c.listarCategorias();
            int cont = 0;
          %>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                   <a href="VerCategoriaServlet?categoria=<%=cx.getNombre()%>" class="btn btn-info">Ver</a>
                  </td>

<!-- BotÛn Editar -->
<td>
  <form action="EditarCategoria.jsp" method="get">
    <!-- Pasamos el nombre de usuario como par·metro oculto -->
    <input type="hidden" name="categoria" value="<%= cx.getNombre() %>">
    <button type="submit" class="btn btn-warning">Editar</button>
                  ...
                  <!-- BotÛn Eliminar -->
<td>
    <form action="EliminarCategoriaServlet" method="post">
        <input type="hidden" name="categoria_id" value="<%= cx.getCategoria_id() %>">
        <button type="submit" class="btn btn-danger" onclick="return confirm('øEst·s seguro de que quieres eliminar este usuario?');">Eliminar</button>
    </form>
</td>
                </tr>
