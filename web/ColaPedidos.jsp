  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid px-4">
        ...
        <a href="CrearPedido.jsp" class="btn btn-success mb-3">Crear Nuevo Pedido</a>
        
          <%
            Pedido d = new Pedido();
            LinkedList<Pedido> lista = d.listarPedidos();
            int cont = 0;
          %>
            ...
            <table class="table table-striped">
              <thead>
                <tr>
                  ...
                  <th class="top" scope="col">Cliente</th>
                  <th class="top" scope="col">Fecha</th>
                  <th class="top" scope="col">Total</th>
                  <th class="top" scope="col">Estado</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><%= dx.getClienteId() %></td>
                  <td><%= dx.getFecha() %></td>
                  <td><%= dx.getTotal() %></td>
                  <td><%= dx.getEstado() %></td>

                  <td>
                         <a href="VerPedidoServlet?pedidoId=<%= dx.getPedidoId() %>" class="btn btn-info">Ver</a>
                  </td>


<!-- BotÛn Editar -->
<td>
    <a href="EditarPedidoServlet?pedidoId=<%= dx.getPedidoId()%>" class="btn btn-warning">Editar</a>
</td>
                  ...
                  <!-- BotÛn Eliminar -->
<td>
    <a href="EliminarPedidoServlet?pedidoId=<%= dx.getPedidoId() %>" class="btn btn-danger" onclick="return confirm('øEst·s seguro de que deseas eliminar este producto?');">Eliminar</a>
</td>
